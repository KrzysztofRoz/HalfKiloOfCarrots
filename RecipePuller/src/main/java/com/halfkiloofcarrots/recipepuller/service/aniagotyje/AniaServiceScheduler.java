...
public class AniaServiceScheduler {
    ...
    public void fetchUpdatedRecipes() throws IOException {
        String slugsString = new String(Files.readAllBytes(Paths.get("C:\\Users\\Brungold\\Desktop\\JAVA\\HalfKiloOfCarrots\\RecipePuller\\src\\main\\resources\\SlugsJson.json")));
